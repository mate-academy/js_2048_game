...
class Game {
  ...
  constructor(
    ...
    this.initialState = this.gameBoard(initialState);
    this.board = this.gameBoard(initialState);
    this.score = 0;
    this.status = 'idle';
  }
   ...
   */
  getState() {
    return this.gameBoard(this.board);
  }
  ...
  restart() {
    this.status = 'idle';
    this.board = this.gameBoard(this.initialState);
    this.score = 0;
  }
