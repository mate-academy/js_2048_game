...
const scoreText = document.querySelector('.game_score');
const table = document.querySelector('.game_field');
...
function renderField() {
  for (let r = 0; r < rows; r++) {
    for (let c = 0; c < columns; c++) {
      ...
      table.rows[r].cells[c].classList.add('field_cell');
      table.rows[r].cells[c].classList.add(`field_cell--${board[r][c]}`);
